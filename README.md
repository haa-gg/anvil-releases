...
2. Click the **Anvil icon** in your toolbar to open the importer window.
3. Paste the plain text of your magic item into the large text box. Make sure your text follows standard 5e formatting (e.g., "Weapon (longsword), rare (requires attunement)").
